          ...
          {/* Checkboxes (not functional) */}
            <div className="flex flex-col">
              <label className="hover:cursor-pointer">
                <input type="checkbox" className="hover:cursor-pointer" checked={horizontalOn} onChange={(e) => {setHorizonalOn(e.target.checked)}}></input>
                Horizonal Divider
              </label>
              <label className="hover:cursor-pointer">
                <input type="checkbox" className="hover:cursor-pointer" checked={darkModeOn} onChange={(e) => {setDarkModeOn(e.target.checked)}}></input>
                Dark Mode
              </label>
            </div>
          </div>
